...
def hallway2():
   ...
   while valid == False:
    ...
    direction = input("Theres doors West,East and North (Elevator). Input either W,E,N or S to choose your direction")
    if direction.upper() == "W":
            valid = True
            grandBedroom()
    elif direction.upper() == "E":
...
def balcony():
    ...
    print("You approach the balcony door and reach for the handle...")
    
    if key1 == True and key2 == True:
        print("You open the doors to the balcony as a cooling breeze brushes your cheeks. The clouds have parted and the morning sun's beams grace your skin.")
        time.sleep(1)
        print("You slowly make your way down from the balcony free from the entrapping walls of the house")
        print("Journeying home through the nearbye forest")
        print("""
            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠓⠒⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣀⠀⠀⠀⠀⠀⢠⢤⣤⣤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡠⠔⠒⠒⠲⠎⠀⠀⢹⡃⢀⣀⠀⠑⠃⠀⠈⢀⠔⠒⢢⠀⠀⠀⡖⠉⠉⠉⠒⢤⡀⠀⠀⠀⠀⠀
        ...
        print("You are unable to open the door. Youre misssing a key")
